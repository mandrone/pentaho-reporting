...
/**
 * The initializer is used to setup the file system storage provider and to register the providers at the
 * configfactory.
 * <p/>
...
public class FileConfigStoreModuleInitializer implements ModuleInitializer
{
   ...
   * @throws ModuleInitializeException if an error occured or the directory could not be created.
